...
class AssetListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Asset
        fields = ['symbol', 'name', 'icon_url', 'current_price', 'price_change_24h', 'volume_24h']

class AssetDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = Asset
        fields = ['symbol', 'name', 'icon_url', 'current_price', 'price_change_24h', 'volume_24h', 'is_active', 'created_at', 'updated_at']
