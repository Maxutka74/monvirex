...
class AdminUserTransactionAllSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ('id', 'user_email', 'transaction_type', 'amount', 'status', 'created_at')
...
class AdminUserCryptoTransactionAllSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'user_email', 'asset', 'transaction_type', 'crypto_amount', 'usdt_amount', 'status', 'created_at')
...
class AdminStatsSerializer(serializers.Serializer):
    ...
    total_wallet_balance = serializers.DecimalField(max_digits=10, decimal_places=2, read_only=True)
