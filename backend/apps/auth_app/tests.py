...
class AuthServiceTest(TestCase):
    ...
    def test_resend_register_code_expired(self):
        with self.assertRaises(ValidationError) as e:
            AuthService.resend_register_code(
                {'reg_id': '43t3g3ge-sdcd43t34-rf3342r4767-r784635'}
            )
    ...
    def test_confirm_register_expired(self):
        ...
        with self.assertRaises(ValidationError) as e:
            AuthService.confirm_register(
                {'reg_id': '43t3g3ge-sdcd43t34-rf3342r4767-r784635', 'code': code}
            )
        self.assertIn('Code has expired', str(e.exception.detail))
    ...
    def test_login_wrong_password(self):
        ...
        with self.assertRaises(ValidationError) as e:
            AuthService.login({'email': 'test@gmail.com', 'password': 'Test123456!'})
    ...
    def test_login_wrong_email(self):
        ...
        with self.assertRaises(ValidationError) as e:
            AuthService.login({'email': 'test12@gmail.com', 'password': 'Test1234!'})
    ...
    def test_resend_password_code(self):
        ...
        second_result_reset_id = AuthService.resend_password_code(
            {'reset_id': reset_id}
        )
        self.assertEqual(
            second_result_reset_id['reset_id'], first_result_reset_id['reset_id']
        )

    def test_resend_password_code_expired(self):
        with self.assertRaises(ValidationError) as e:
            AuthService.resend_password_code(
                {'reset_id': '43t3g3ge-sdcd43t34-rf3342r4767-r784635'}
            )
    ...
    def test_change_password_success(self):
        ...
        reset_verify_id = AuthService.confirm_reset_password(
            {'reset_id': reset_id, 'code': code}
        )

        res = AuthService.change_password(
            {'reset_verify_id': reset_verify_id, 'password': 'Monvirex12'}
        )
...
class AuthServiceApiTest(TestCase):
    ...
    def _register_and_confirm(self):
        register_response = self.client.post(
            '/api/auth/register/', data=self.register_data
        )
        ...
        confirm_response = self.client.post(
            '/api/auth/verify-email/', data={'reg_id': reg_id, 'code': code}
        )
    ...
    def _reset_and_verify_reset_id(self):
        reset_id = self.client.post(
            '/api/auth/reset-password/', data={'email': 'test@gmail.com'}
        )

        reset_code = cache.get(f'reset:{reset_id.data["reset_id"]}')['code']

        reset_verify_id = self.client.post(
            '/api/auth/verify-reset-password/',
            data={'reset_id': reset_id.data['reset_id'], 'code': reset_code},
        )
    ...
    def test_resend_register(self):
        ...
        first_response = self.client.post(
            '/api/auth/resend-register-code/',
            data={'reg_id': register_response.data['reg_id']},
        )
    ...
    def test_resend_register_invalid(self):
        response = self.client.post(
            '/api/auth/resend-register-code/',
            data={'reg_id': '43t3g3ge-sdcd43t34-rf3342r4767-r784635'},
        )
    ...
    def test_confirm_register_code_invalid(self):
        ...
        confirm_response = self.client.post(
            '/api/auth/verify-email/', data={'reg_id': reg_id, 'code': '000000'}
        )
    ...
    def test_confirm_register_cache_invalid(self):
        ...
        confirm_response = self.client.post(
            '/api/auth/verify-email/', data={'reg_id': '1313432', 'code': code}
        )
    ...
    def test_login_api(self):
        ...
        login_response = self.client.post(
            '/api/auth/login/',
            data={'email': self.register_data['email'], 'password': 'Test1234!'},
        )
    ...
    def test_login_api_invalid(self):
        ...
        login_response = self.client.post(
            '/api/auth/login/',
            data={'email': 'test12@gmail.com', 'password': 'Test1234!'},
        )
    ...
    def test_reset_password(self):
        ...
        reset_id = self.client.post(
            '/api/auth/reset-password/', data={'email': self.register_data['email']}
        )
    ...
    def test_reset_password_invalid(self):
        ...
        reset_id = self.client.post(
            '/api/auth/reset-password/', data={'email': 'test12@gmail.com'}
        )
    ...
    def test_resend_password(self):
        ...
        first_response = self.client.post(
            '/api/auth/resend-password-code/',
            data={'reset_id': reset_id.data['reset_id']},
        )
        ...
        self.assertEqual(second_response.status_code, status.HTTP_202_ACCEPTED)
        self.assertEqual(
            second_response.data['reset_id'], first_response.data['reset_id']
        )

    def test_resend_password_invalid(self):
        response = self.client.post(
            '/api/auth/resend-password-code/',
            data={'reset_id': '43t3g3ge-sdcd43t34-rf3342r4767-r784635'},
        )
    ...
    def test_reset_password_confirm_invalid(self):
        ...
        reset_verify_id = self.client.post(
            '/api/auth/verify-reset-password/',
            data={'reset_id': reset_code, 'code': '000000'},
        )
    ...
    def test_login_change_password(self):
        ...
        login_response = self.client.post(
            '/api/auth/login/',
            data={'email': 'test@gmail.com', 'password': 'Yuliy2007!'},
        )
...
class OAuthTest(TestCase):
    ...
    def test_google_auth(self, mock_google_auth):
        ...
        response = self.client.post(
            '/api/auth/google-login/', data={'token': 'fake_token'}
        )
    ...
    def test_google_auth_invalid(self, mock_google_auth):
        mock_google_auth.side_effect = ValidationError(
            {'detail': 'Invalid credentials'}
        )

        response = self.client.post(
            '/api/auth/google-login/', data={'token': 'bad_token'}
        )
    ...
    def test_telegram_auth_invalid(self, mock_telegram_auth):
        mock_telegram_auth.side_effect = ValidationError(
            {'detail': 'Invalid credentials'}
        )
...
class ProfileServiceApiTest(TestCase):
    ...
    def _create_valid_image(self):
        ...
        return SimpleUploadedFile(
            name='avatar.jpg', content=file.read(), content_type='image/jpeg'
        )
    ...
    def _create_invalid_image(self):
        ...
        return SimpleUploadedFile(
            name='avatar.jpg', content=file.read(), content_type='image/gif'
        )
    ...
    def test_update_profile_success(self):
        ...
        response = self.client.patch(
            '/api/auth/profile/',
            data={'first_name': 'Maxx', 'last_name': 'Volt'},
            format='json',
        )
    ...
    def test_update_profile_empty_first_name(self):
        ...
        response = self.client.patch(
            '/api/auth/profile/',
            data={'first_name': '', 'last_name': 'Volt'},
            format='json',
        )
    ...
    def test_update_profile_empty_last_name(self):
        ...
        response = self.client.patch(
            '/api/auth/profile/',
            data={'first_name': 'Maxx', 'last_name': ''},
            format='json',
        )
    ...
    def test_upload_avatar_success(self):
        ...
        response = self.client.patch(
            '/api/auth/profile/avatar/', data={'avatar': avatar}, format='multipart'
        )
    ...
    def test_change_password_success(self):
        ...
        login_data = {'email': 'test@gmail.com', 'password': 'Test2007'}
        ...
        response = self.client.post(
            '/api/auth/profile/change-password/', data=change_password, format='json'
        )
        ...
        response_login = self.client.post(
            '/api/auth/login/', data=login_data, format='json'
        )
    ...
    def test_delete_profile_success(self):
        ...
        response = self.client.post(
            '/api/auth/profile/delete/', data={'password': 'Test1234!'}, format='json'
        )
