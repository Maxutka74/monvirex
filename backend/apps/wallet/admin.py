...
from apps.wallet.models import Wallet, Transaction, CryptoWallet, CryptoTransaction
...
class CryptoWalletAdmin(admin.ModelAdmin):
    list_display = ('user', 'asset', 'amount', 'average_buy_price', 'current_value', 'profit_loss', 'updated_at')
...
class CryptoTransactionAdmin(admin.ModelAdmin):
    list_display = ('user', 'asset', 'transaction_type', 'crypto_amount', 'usdt_amount', 'status', 'created_at')
